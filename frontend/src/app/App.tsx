...
const OrangeSliceLogo = () => (
  <svg width="14" height="14" viewBox="0 0 16 16" style={{ display: "inline-block", verticalAlign: "middle" }}>
    {/* Top-Left */}
    <path d="M 7,7 H 1 A 6,6 0 0,1 7,1 Z" fill="#ff9f43" />
    {/* Top-Right */}
    <path d="M 9,7 V 1 A 6,6 0 0,1 15,7 Z" fill="#feca57" />
    {/* Bottom-Right */}
    <path d="M 9,9 H 15 A 6,6 0 0,1 9,15 Z" fill="#ff7f50" />
    {/* Bottom-Left */}
    <path d="M 7,9 V 15 A 6,6 0 0,1 1,9 Z" fill="#ff6b6b" />
  </svg>
);
